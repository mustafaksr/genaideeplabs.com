...
class GatewayIconsRenderer implements GatewayIconsRendererInterface
{
    ...
    public function renderIcons(): string
    {
        ...
        $css = <<<CSS
input#payment_method_payoneer-checkout:checked + label > #gateway-icons-payoneer {
\tdisplay: none;
}
CSS;
        return sprintf('<style>%1$s</style><span id="gateway-icons-payoneer">%2$s</span>', $css, $icons);
    }
    /**
     * @return string[]
     */
