...
class PaymentGateway extends WC_Payment_Gateway
{
    ...
    public function __construct(string $id, ContainerInterface $serviceLocator)
    {
        ...
        add_filter('woocommerce_settings_api_sanitized_fields_' . $this->id, [$this, 'filterVirtualFields'], \PHP_INT_MIN);
    }
     ...
     *
     * It filters fields with the 'virtual' field type and fields with the 'save` attribute set to false.
