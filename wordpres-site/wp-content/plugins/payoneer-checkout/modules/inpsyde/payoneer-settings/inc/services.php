...
return static function (): array {
    ...
    return [
        ...
        'payoneer_settings.assets.js.payment_methods.data' => new Factory(['core.http.settings_url'], static function (UriInterface $generalSettingsUrl) {
            return [
                'paymentMethods' => ['payoneer-checkout', 'payoneer-hosted'],
        ...
        'payment_methods.payoneer-checkout.gateway_icons_renderer' => new Constructor(PaymentSettingsPageIconsRenderer::class, ['checkout.gateway_icon_elements_all']),
